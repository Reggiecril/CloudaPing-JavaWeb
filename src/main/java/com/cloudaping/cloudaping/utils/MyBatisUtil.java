...
import com.cloudaping.cloudaping.entity.productType.AudioVideo;
import com.cloudaping.cloudaping.entity.productType.Computer;
import com.cloudaping.cloudaping.entity.productType.Mobile;
...
public class MyBatisUtil {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(getResultMapNew(AudioVideo.class));
